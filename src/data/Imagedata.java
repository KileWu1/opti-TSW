...
import static Util.ShopUtil.MarksManActive;
import static Util.ShopUtil.WariorActive;
...
public class Imagedata {
    ...
    public static BufferedImage battlepImg;
    public static BufferedImage battlesImg;
    public static BufferedImage battlestImg;
		static {
	        try {
	        	
	        		gameBgImg=ImageIO.read(new File(System.getProperty("user.dir") + "/res/GameBg.png"));
	        		battleBgImg=ImageIO.read(new File(System.getProperty("user.dir") + "/res/BattleBg2.png"));//OR2
	        	
	            battlepImg=ImageIO.read(new File(System.getProperty("user.dir") + "/res/5.png"));
	            battlesImg=ImageIO.read(new File(System.getProperty("user.dir") + "/res/6.png"));
	            battlestImg=ImageIO.read(new File(System.getProperty("user.dir") + "/res/7.png"));
